        ...
        btnEso.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new Thread(new Runnable() {
                    public void run() {
                        final Bitmap bitmap = loadImageFromNetwork("https://w7.pngwing.com/pngs/299/12/png-transparent-round-green-logo-3d-computer-graphics-circle-3d-modeling-icon-button-miscellaneous-grass-sphere.png");
